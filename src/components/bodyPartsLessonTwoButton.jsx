...
class BodyPartsLessonTwoButton extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  renderNextPage() {
    return (
      ...
      >
        <Link to={this.props.letterSet[3].link}>
          <img
            src={nextButtonImage}
  ...
  renderPreviousPage() {
    return (
      ...
      >
        <Link to={this.props.letterSet[2].link}>
          <img
    ...
    return (
      <div>
        ...
        <div>
          ...
          <div style={{ marginTop: "-24%", marginLeft: "77%" }}>
            <div>
              <button
                className="btn-food-lesson-video-tiles"
                style={{
                  padding: "4px"
                }}
                onClick={() =>
        ...
        {this.props.letterSet[3].linkKind === "next"
          ? this.renderNextPage()
...
export default BodyPartsLessonTwoButton;
