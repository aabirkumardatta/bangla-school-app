...
class VocabLessonHomePageEight extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <div>
        <div style={{ marginLeft: "-1%" }}>
          <Link to={this.state.imageAudioMap[10].link}>
            <img
        ...
        <div>
          <div style={{ marginTop: "0.5%", marginLeft: "14.5%" }}>
            <span>
              <img
          ...
          <div style={{ marginTop: "2%", marginLeft: "14.5%" }}>
            <span>
              <img
            ...
            <span style={{ marginLeft: "2%" }}>
              <img
                src={this.state.imageAudioMap[6].imageSource}
                alt="could not be loaded"
                style={{
                  height: "32vh",
                  width: "32vh",
                ...
                onClick={() => {
                  const imageAudio = new Howl({
                    src: [this.state.imageAudioMap[6].audio]
                  });
                  imageAudio.volume(4.0);
                  imageAudio.play();
                }}
            ...
            <span style={{ marginLeft: "2%" }}>
              <img
                src={this.state.imageAudioMap[7].imageSource}
                alt="could not be loaded"
                style={{
                  height: "32vh",
                  width: "32vh",
                ...
                onClick={() => {
                  const imageAudio = new Howl({
                    src: [this.state.imageAudioMap[7].audio]
                  });
                  imageAudio.volume(4.0);
                  imageAudio.play();
                }}
        ...
        <div>
          <div
            style={{
              ...
              bottom: "14vh",
              marginLeft: "1%",
              visibility: this.state.imageAudioMap[8].visibility
            }}
          >
            <Link to={this.state.imageAudioMap[8].mapSource}>
              <img
          ...
          <div
            style={{
              ...
              bottom: "14vh",
              right: "14vh",
              visibility: this.state.imageAudioMap[9].visibility
            }}
          >
            <Link to={this.state.imageAudioMap[9].mapSource}>
              <img
                src={nextButtonImage}
                alt="could not be loaded"
                style={{
...
export default VocabLessonHomePageEight;
