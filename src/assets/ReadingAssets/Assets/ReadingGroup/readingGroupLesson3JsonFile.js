import video1 from "./Videos/Lesson3/video1.mp4";
import video2 from "./Videos/Lesson3/video2.mp4";
import video3 from "./Videos/Lesson3/video3.mp4";
import video4 from "./Videos/Lesson3/video4.mp4";
import video5 from "./Videos/Lesson3/video5.mp4";
import video6 from "./Videos/Lesson3/video6.mp4";
import video7 from "./Videos/Lesson3/video7.mp4";
import video8 from "./Videos/Lesson3/video8.mp4";
import video9 from "./Videos/Lesson3/video9.mp4";
import sentence from "./Videos/Lesson3/sentence.mp4";

import videoBoro1 from "./Videos/Lesson3/video-boro-1.mp4";
import videoBoro2 from "./Videos/Lesson3/video-boro-2.mp4";
...
import nextButtonImageBoro from "./ImageAssets/Lesson3/nextButtonImageBoro.png";
...
const pageInformationMapGroupThreePageOne = {
  homePageLink: "/readingWordHomePage",
  introVideo: introVideo,
  nextButtonLink: "/readingWordGroupThreePageTwo",
...
const topImageInformationMapGroupThreePageOne = {
  image: topImage,
  position: "fixed",
  height: "8vh",
  width: "25vh",
...
var readingGroupThreePageOneLessonVideosArray = [
  {
    video: video1,
...
const pageInformationMapGroupThreePageTwo = {
  homePageLink: "/readingWordHomePage",
  introVideo: introVideo,
  nextButtonLink: "/readingWordGroupThreePageThree",
  nextButtonVisibility: "no_hidden",
  nextButtonImage: nextButtonImageBoro,
  previousButtonLink: "/readingWordGroupThreePageOne",
  previousButtonVisibility: "no_hidden",
};

const topImageInformationMapGroupThreePageTwo = {
  image: topImage,
  position: "fixed",
  height: "8vh",
  width: "25vh",
...
var readingGroupThreePageTwoLessonVideosArray = [
  {
    video: video7,
...
var readingGroupThreePageTwoQuizArray = [
  {
...
const pageInformationMapGroupThreePageThree = {
  homePageLink: "/readingWordHomePage",
  introVideo: introVideo,
  nextButtonLink: "/readingWordGroupThreePassage",
  nextButtonVisibility: "no_hidden",
  nextButtonImage: nextButtonImage,
  previousButtonLink: "/readingWordGroupThreePageTwo",
  previousButtonVisibility: "no_hidden",
};

const topImageInformationMapGroupThreePageThree = {
  image: topImageBoro,
  position: "fixed",
  height: "8vh",
  width: "25vh",
...
var readingGroupThreePageThreeLessonVideosArray = [
  {
    video: videoBoro1,
    buttonImage: buttonImageLesson1,
    position: "fixed",
